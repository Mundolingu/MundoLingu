...
const TEACHERS: { [k in Lang]: { name: string; teaches: string; meta: string; phil: string; spec: string; photo?: string }[] } = {
  en: [
    ...
    { name: "Dania Ordonez", teaches: "English & Spanish", meta: "12+ years · United States · Istanbul", phil: "“Real-life goals, real energy — every single lesson.”", spec: "English and Spanish teacher with over 12 years' experience across the world, including the United States and Istanbul. She teaches around real-life targets and brings the best energy to every lesson.", photo: "/team-dania.jpg" },
    { name: "Samantha Lozano", teaches: "English & Spanish", meta: "CEO · International English teacher with experience in Dubai", phil: "“I teach people to create their own opportunities — because I've lived it.”", spec: "CEO at MundoLingu and an international English teacher with experience in Dubai. Alongside seeing the world, she teaches English and Spanish online — showing people how to create opportunities to better their lives, from real experience gained across the globe.", photo: "/team-samantha.jpg" },
    { name: "Paty Gradilla", teaches: "English & Spanish", meta: "International English teacher with experience in Dubai · Qualified in Mexico", phil: "“A clear structure that gets you speaking, fast.”", spec: "An international English teacher with experience in Dubai, qualified as an English language teacher in Mexico. She teaches English and Spanish online and speaks from real experience travelling the world, with a clear, structured method that makes progress fast.", photo: "/team-paty.jpg" },
  ],
  es: [
    ...
    { name: "Dania Ordonez", teaches: "Inglés y español", meta: "12+ años · Estados Unidos · Estambul", phil: "“Metas de la vida real, energía real, en cada clase.”", spec: "Profesora de inglés y español con más de 12 años de experiencia por el mundo, incluidos Estados Unidos y Estambul. Enseña en torno a metas reales y trae la mejor energía a cada clase.", photo: "/team-dania.jpg" },
    { name: "Samantha Lozano", teaches: "Inglés y español", meta: "CEO · Profesora internacional de inglés con experiencia en Dubái", phil: "“Enseño a la gente a crear sus propias oportunidades, porque yo lo he vivido.”", spec: "CEO en MundoLingu y profesora internacional de inglés con experiencia en Dubái. Además de recorrer el mundo, enseña inglés y español online, mostrando a las personas cómo crear oportunidades para mejorar su vida, desde la experiencia real ganada por todo el planeta.", photo: "/team-samantha.jpg" },
    { name: "Paty Gradilla", teaches: "Inglés y español", meta: "Profesora internacional de inglés con experiencia en Dubái · Titulada en México", phil: "“Una estructura clara que te hace hablar, rápido.”", spec: "Profesora internacional de inglés con experiencia en Dubái, titulada como profesora de inglés en México. Enseña inglés y español online y habla desde la experiencia real de viajar por el mundo, con un método claro y estructurado que hace avanzar rápido.", photo: "/team-paty.jpg" },
  ],
};
